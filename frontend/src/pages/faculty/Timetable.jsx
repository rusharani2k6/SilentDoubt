      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full">
        <div className="mb-8">
          ...
          <p className="text-xs sm:text-sm text-[#3D3F4A] mt-1">
            Weekly lecture distribution, classroom sections, and time slots
          </p>
        </div>
                    ...
                    {dayEntries.map((e) => (
                      ...
                      >
                        <div className="flex items-center justify-between mb-1.5">
                          <span className="text-xs font-bold text-[#3DA8A5]">
                            Section {e.section}
                          </span>
                          <span className="text-[11px] text-[#8A8B97] font-medium flex items-center gap-1">
                            <Clock className="w-3 h-3" />
                            {e.start_time} - {e.end_time}
                          </span>
                        </div>
                        <h4 className="text-xs sm:text-sm font-bold text-[#0D0F0D] leading-snug">{e.subject}</h4>
                      </div>
                    ))}
                  </div>
                )}
